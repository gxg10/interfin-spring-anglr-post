...
//        stiriRepository.save(new StiriEntity("Romgaz cea mai buna", "este ca mia profitabila societate din " +
//                "industrie"));
//        stiriRepository.save(new StiriEntity("Hidroelectrica scandalul baietilor destepti din energie",
